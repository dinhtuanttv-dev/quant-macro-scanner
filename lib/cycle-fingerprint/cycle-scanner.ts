...
/**
 * Diem chat luong tong hop - trong so mac dinh 40/20/20/20 (giong dung
 * PersonalizationSettings mac dinh o Frontend, de nguoi dung tuy chinh sau
 * khop dung con so nay khong bi lech nghia).
 */
export function computeQualityScore(
  ...
  // Lieu chua co nguon thanh khoan toan thi truong de xep hang tuyet doi o
  // Giai doan 1 - dung PROXY don gian: khoi luong 20 phien gan nhat so voi
  // trung binh ca giai doan quet, KHONG phai xep hang thanh khoan that giua
  // cac ma. Gan nhan ESTIMATED ro rang o Frontend (QuantValue.source).
  let liquidity = 0.5;
  if (bars.length >= 20) {
