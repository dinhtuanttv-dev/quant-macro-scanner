// app/api/catalysts/scan/route.ts - da cap nhat them upcomingEvents + tickerImpacts
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json({ ok: true, scannedAt: snapshot.scannedAt, sectorCount: snapshot.sectors.length, ingestResult: snapshot.ingestResult, upcomingEventCount: snapshot.upcomingEvents.length });
  } catch (err) {
